    ...
    <aside class="hidden w-72 border-r border-slate-200 bg-white lg:block">
        ...
        @php
            $menuItems = [
                ...
                ['label' => 'Pool Queue', 'route' => 'pool.queue', 'permissions' => ['pool.view-all', 'pool.view-own']],
                ['label' => 'Finance Dashboard', 'route' => 'finance.index', 'permissions' => ['purchase-orders.view', 'invoices.view', 'payments.view', 'evouchers.view']],
                ['label' => 'Purchase Orders', 'route' => 'finance.purchase-orders.index', 'permissions' => ['purchase-orders.view']],
                ['label' => 'Invoices', 'route' => 'finance.invoices.index', 'permissions' => ['invoices.view']],
