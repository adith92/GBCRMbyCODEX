<x-layouts.app :title="'Edit Maintenance'" :header="'Maintenance / Edit'">
    ...
    <section class="rounded-lg border bg-white p-4">
        <form wire:submit="save" class="grid gap-3 md:grid-cols-2">
            ...
            <div class="md:col-span-2"><label class="text-xs text-slate-500">Title</label><input wire:model="title" class="mt-1 w-full rounded border-slate-300 text-sm"></div>
            ...
            <div class="md:col-span-2 flex justify-end gap-2">
                <x-back-link :fallback="route('maintenance.show', $maintenanceLog)" />
                <button class="rounded bg-slate-900 px-3 py-2 text-sm text-white">Update Maintenance</button>
            </div>
        </form>
    </section>
</x-layouts.app>
