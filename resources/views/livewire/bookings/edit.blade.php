    ...
    <section class="rounded-lg border border-slate-200 bg-white p-4">
        <form wire:submit="save" class="grid gap-3 md:grid-cols-2">
            ...
            <div class="md:col-span-2 flex justify-end gap-2">
                <a href="{{ route('bookings.show', $booking) }}" class="rounded-md border border-slate-300 px-3 py-2 text-sm">Cancel</a>
                <button class="rounded-md bg-slate-900 px-3 py-2 text-sm text-white">Update Booking</button>
            </div>
        </form>
    </section>
</x-layouts.app>
